...
* where.country -> "Observation.extension[exposureAddress].valueAddress.country" "Where - Switzerland/Liechtenstein or abroad (Exposure Address Extension)"
* where.preciseLocation -> "Observation.extension[exposureAddress].valueAddress.city" "Precise location"
* where.unknown -> "Observation.extension[exposureAddress]" "unknown -> extension with data-absent-reason"
