...
- [Laboratory Information](ServiceRequest-ChEkmServiceRequestExampleHepatitisC.json.html): The clinical findings are linked to a [screening sample taken on January 19, 2026](Specimen-ChEkmSpecimenExampleHepatitisC.json.html), analyzed by [LabSan GmbH](Organization-ChEkmOrganizationLabExample.json.html).
...
- [Laboratory Information](ServiceRequest-ChEkmServiceRequestExampleInvasivePneumococcalDisease.json.html): The diagnosis is supported by a [blood specimen collected on January 27, 2026](Specimen-ChEkmSpecimenExampleInvasivePneumococcalDisease.json.html), and analyzed by [LabSan GmbH](Organization-ChEkmOrganizationLabExample.json.html).
