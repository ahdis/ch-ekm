...
- [Laboratory Information](ServiceRequest-ChEkmServiceRequestExample-InvasiveStreptococcusPneumoniae.json.html): The diagnosis is supported by a [blood specimen collected on January 27, 2026](Specimen-ChEkmSpecimenExample-InvasiveStreptococcusPneumoniae.json.html), and analyzed by [Viollier Bern AG](Organization-ChEkmOrganizationLabExample.json.html).
