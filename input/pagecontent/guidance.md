...
* **VCT Code**
   ...
   * [Example](Patient-ChEkmPatientVCT.json.html): kste12345 (Patient.identifier[LocalPid]= kste12345, Patient.name.family/Patient.name.given = masked, no telecom and no street address)
* **HIV Code**
   * Organism: HIV/AIDS
